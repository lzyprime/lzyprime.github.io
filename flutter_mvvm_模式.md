...
![mvvm](img/flutter_mvvm_模式.1.png)
...
![pubspec.yaml](img/flutter_mvvm_模式.2.png)
...
- ###  state == 0， 初始状态
![state0](img/flutter_mvvm_模式.3.png)

- ### state == 1, 点击登录后，显示加载
![state1](img/flutter_mvvm_模式.4.png)

- ### state == 2, 登录成功
![state2](img/flutter_mvvm_模式.5.png)
